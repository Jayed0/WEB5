  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Manage Supplier/Product Wise Purchase</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            ...
            <div class="card">
              ...
              <div class="card-body">
                ...
                <div class="show_supplier" style="display: none;">
                  <form method="GET" action="<?php echo e(route('purchase.report.supplier.wise.pdf')); ?>" id="supplierWiseForm" target="_blank">
                    <div class="form-row">
                      <div class="col-sm-8">
                ...
                <div class="show_product" style="display: none;">
                  <form method="GET" action="<?php echo e(route('purchase.report.product.wise.pdf')); ?>" id="productWiseForm" target="_blank">
                    <div class="form-row">
                      <div class="col-sm-4">
...
<?php echo $__env->make('backend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\pos\resources\views/backend/purchase/supplier-product-wise-purchase-report.blade.php ENDPATH**/ ?>