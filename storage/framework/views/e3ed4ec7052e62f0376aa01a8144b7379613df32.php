        ...
        <div class="row">
          ...
          <section class="col-md-12">
            ...
            <div class="card">
              ...
              <div class="card-body">
                <form method="post" action="<?php echo e(route('products.store')); ?>" id="myForm">
                  <?php echo csrf_field(); ?>
                  <div class="form-row">
...
<?php echo $__env->make('backend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\pos\resources\views/backend/product/add-product.blade.php ENDPATH**/ ?>