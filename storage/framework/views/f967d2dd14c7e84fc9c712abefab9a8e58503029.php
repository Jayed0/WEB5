                ...
                <table id="example1" class="table table-bordered table-hover table-responsive">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        <?php if($purchase->status=='0'): ?>
                        <a title="Approve" id="approveBtn" class="btn btn-sm btn-success" href="<?php echo e(route('purchase.approve',$purchase->id)); ?>"><i class="fa fa-check-circle"></i></a>
                        <?php endif; ?>
                      </td>
                    </tr>
...
<?php echo $__env->make('backend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\pos\resources\views/backend/purchase/view-pending-list.blade.php ENDPATH**/ ?>