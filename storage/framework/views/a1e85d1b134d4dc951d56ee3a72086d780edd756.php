          ...
          <section class="col-md-12">
            ...
            <div class="card">
              <div class="card-header">
                <h3>Edit Customer
                  <a class="btn btn-success float-right btn-sm" href="<?php echo e(route('customers.view')); ?>"><i class="fa fa-list"></i> Customer List</a>
                </h3>
              </div><!-- /.card-header -->
              <div class="card-body">
                <form method="post" action="<?php echo e(route('customers.update',$editData->id)); ?>" id="myForm">
                  <?php echo csrf_field(); ?>
                  <div class="form-row">
...
<?php echo $__env->make('backend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\pos\resources\views/backend/customer/edit-customer.blade.php ENDPATH**/ ?>