                  ...
                  <tbody>
                   ...
                   $buying_total_qty = App\Model\Purchase::where('category_id',$product->category_id)->where('product_id',$product->id)->where('status','1')->sum('buying_qty');
                    ...
                    <tr>
                    	...
                    	<td style="text-align: center;"><?php echo e($product['supplier']['name']); ?></td>
...
</html><?php /**PATH E:\xampp\htdocs\pos\resources\views/backend/pdf/product-wise-purchase-report-pdf.blade.php ENDPATH**/ ?>