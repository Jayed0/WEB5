          ...
          <section class="col-md-12">
            ...
            <div class="card">
              <div class="card-header">
                <h3>Add Invoice
                  <a class="btn btn-success float-right btn-sm" href="<?php echo e(route('invoice.view')); ?>"><i class="fa fa-list"></i> Invoice List</a>
                </h3>
              </div><!-- /.card-header -->
              <div class="card-body">
                  <div class="form-row">
                    <div class="form-group col-md-2">
                      ...
                      <input type="text" name="invoice_no" id="invoice_no" class="form-control" value="<?php echo e($invoice_no); ?>" readonly style="background-color: #ADFF2F;">
                      <font style="color: red"><?php echo e(($errors->has('invoice_no'))?($errors->first('invoice_no')):''); ?></font>
                    </div>
                    <div class="form-group col-md-2">
                      <label for="date">Date</label>
                      <input type="text" name="date" id="date" class="form-control datepicker" value="<?php echo e($date); ?>" placeholder="YYYY-MM-DD" readonly>
                    ...
                    <div class="form-group col-md-2">
                      <label for="current_stock_qty">Stock(Quantity)</label>
                      <input type="text" name="current_stock_qty" id="current_stock_qty" class="form-control" readonly style="background-color: #ADFF2F;">
                      <font style="color: red"><?php echo e(($errors->has('product_id'))?($errors->first('product_id')):''); ?></font>
                    </div>
              ...
              <div class="card-body">
                <form method="post" action="<?php echo e(route('invoice.store')); ?>" id="myForm">
                  <?php echo csrf_field(); ?>
                  ...
                  <div class="form-row">
                    ...
                    <div class="form-group col-md-9">
                      ...
                      <select name="customer_id" id="customer_id" class="form-control select2 select2bs4">
  ...
  <script type="text/javascript">
    $(function(){
      $(document).on('change','#product_id',function(){
        ...
        $.ajax({
          url:"<?php echo e(route('check-product-stock')); ?>",
          type:"GET",
...
<?php echo $__env->make('backend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\pos\resources\views/backend/invoice/add-invoice.blade.php ENDPATH**/ ?>