          ...
          <section class="col-md-12">
            ...
            <div class="card">
              <div class="card-header">
                <h3>Add Purchase
                  <a class="btn btn-success float-right btn-sm" href="<?php echo e(route('purchase.view')); ?>"><i class="fa fa-list"></i> Purchase List</a>
                </h3>
              </div><!-- /.card-header -->
              <div class="card-body">
                  <div class="form-row">
                    ...
                    <div class="form-group col-md-4">
                      ...
                      <font style="color: red"><?php echo e(($errors->has('purchase_no'))?($errors->first('purchase_no')):''); ?></font>
                    </div>
                    <div class="form-group col-md-4">
              ...
              <div class="card-body">
                <form method="post" action="<?php echo e(route('purchase.store')); ?>" id="myForm">
                  <?php echo csrf_field(); ?>
...
<?php echo $__env->make('backend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\pos\resources\views/backend/purchase/add-purchase.blade.php ENDPATH**/ ?>