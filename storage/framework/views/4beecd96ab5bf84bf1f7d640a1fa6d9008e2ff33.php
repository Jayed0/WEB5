				...
				<table>
					<tbody>
						<tr>
							<td width="25%"></td>
							<td>
								<u><strong style="font-size: 16px">Daily Purchase Report (<?php echo e(date('d-m-Y',strtotime($start_date))); ?> - <?php echo e(date('d-m-Y',strtotime($end_date))); ?>)</strong></u>
							</td>
							<td></td>
						</tr>
					</tbody>
				...
				<table width="100%" border="1" style="text-align: center;">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td style="text-align: center;"><?php echo e($purchase->purchase_no); ?></td>
                      <td style="text-align: center;"><?php echo e(date('d-m-Y',strtotime($purchase->date))); ?></td>
                      <td style="text-align: center;"><?php echo e($purchase['supplier']['name']); ?></td>
                      <td style="text-align: center;"><?php echo e($purchase['category']['name']); ?></td>
                      <td style="text-align: center;"><?php echo e($purchase['product']['name']); ?></td>
                      <td style="text-align: center;"><?php echo e($purchase->description); ?></td>
                      <td style="text-align: center;"><?php echo e($purchase->updated_by_name); ?></td>
                      <td style="text-align: center;">
                      ...
                      <td style="text-align: center;"><?php echo e($purchase->unit_price); ?></td>
                      <td style="text-align: center;"><?php echo e($purchase->buying_price); ?></td>
                    </tr>
                    <?php
...
</html><?php /**PATH E:\xampp\htdocs\pos\resources\views/backend/pdf/daily-purchase-report-pdf.blade.php ENDPATH**/ ?>