				...
				<table>
					<tbody>
						<tr>
							<td width="55%"></td>
							<td>
								<u><strong style="font-size: 16px">Credit Customer Report</strong></u>
							</td>
							<td></td>
						</tr>
					</tbody>
				...
				<table border="1" width="100%">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td style="text-align: center;"><?php echo e($payment->due_amount); ?> TK</td>
                    </tr>
                    <?php
                    ...
                    <tr>
                      ...
                      <td style="text-align: center; font-weight: bold;"><?php echo e($total_due); ?> TK</td>
                    </tr>
                  </tbody>
                </table><br>
                <?php
...
</html><?php /**PATH E:\xampp\htdocs\pos\resources\views/backend/pdf/customer-credit-pdf.blade.php ENDPATH**/ ?>