...
<html>
<head>
	<title>Supplier Wise Purchase Report PDF</title>
				...
				<table>
					<tbody>
						<tr>
							<td width="45%"></td>
							<td>
								<u><strong style="font-size: 16px"> Supplier Wise Purchase Report</strong></u>
							</td>
							<td></td>
						</tr>
					</tbody>
				 ...
				 <table border="1" width="100%">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td style="text-align: center;"><?php echo e($product['purchase']['purchase_no']); ?></td>
                      <td style="text-align: center;"><?php echo e($product['category']['name']); ?></td>
                      <td style="text-align: center;"><?php echo e($product->name); ?></td>
                      <td style="text-align: center;"><?php echo e($product['purchase']['description']); ?></td>
                      <td style="text-align: center;"><?php echo e($product['purchase']['created_by_name']); ?></td>
                      <td style="text-align: center;"><?php echo e($product['purchase']['updated_by_name']); ?></td>
...
</html><?php /**PATH E:\xampp\htdocs\pos\resources\views/backend/pdf/supplier-wise-purchase-report-pdf.blade.php ENDPATH**/ ?>