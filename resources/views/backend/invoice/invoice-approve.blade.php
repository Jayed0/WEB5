                ...
                <table width="100%">
                  <tbody>
                    <tr>
                      ...
                      <td width="35%"><p><strong>Email :</strong> {{$payment['customer']['email']}}</p></td>
                    </tr>
                    <tr>
                      <td width="15%"></td>
                      <td width="85%" colspan="3"><p><strong>Address :</strong> {{$payment['customer']['address']}}</p></td>
                    </tr>
                    <tr>
                      <td width="15%"></td>
                  ...
                  <table border="1" width="100%" style="margin-bottom: 10px;">
                    ...
                    <tbody>
                      ...
                      <tr class="text-center">
                        ...
                        <td style="background-color: #ddd; padding: 1px;">{{$details['product']['quantity']}}</td>
