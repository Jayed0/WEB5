              ...
              <div class="card-body">
                  <div class="form-row">
                    <div class="form-group col-md-2">
                      ...
                      <input type="text" name="invoice_no" id="invoice_no" class="form-control" value="{{$invoice_no}}" readonly style="background-color: #ADFF2F;">
                      <font style="color: red">{{($errors->has('invoice_no'))?($errors->first('invoice_no')):''}}</font>
                    </div>
                    <div class="form-group col-md-2">
                      <label for="date">Date</label>
                      <input type="text" name="date" id="date" class="form-control datepicker" value="{{$date}}" placeholder="YYYY-MM-DD" readonly>
