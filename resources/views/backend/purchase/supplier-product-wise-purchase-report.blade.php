            ...
            <div class="card">
              ...
              <div class="card-body">
                ...
                <div class="show_supplier" style="display: none;">
                  <form method="GET" action="{{route('purchase.report.supplier.wise.pdf')}}" id="supplierWiseForm" target="_blank">
                    <div class="form-row">
                      <div class="col-sm-8">
                ...
                <div class="show_product" style="display: none;">
                  <form method="GET" action="{{route('purchase.report.product.wise.pdf')}}" id="productWiseForm" target="_blank">
                    <div class="form-row">
                      <div class="col-sm-4">
