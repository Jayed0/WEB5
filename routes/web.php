...
Route::group(['middleware'=>'auth'],function(){
	...
	Route::prefix('purchase')->group(function(){
		...
		Route::get('/purchase/report/supplier/product/wise', 'Backend\PurchaseController@supplierProductWisePurchase')->name('purchase.report.supplier.product.wise');
		Route::get('/purchase/report/supplier/wise/pdf', 'Backend\PurchaseController@supplierWisePurchasePdf')->name('purchase.report.supplier.wise.pdf');
		Route::get('/purchase/report/product/wise/pdf', 'Backend\PurchaseController@productWisePurchasePdf')->name('purchase.report.product.wise.pdf');
	});
